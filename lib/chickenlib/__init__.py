"""
Chickenlib is a package responsible for handling the chicken system in the bot.

Modules included:

* chickenhandlers: Contains functions for handling events related to chickens.
* chickenshared: Contains shared functions for the chicken system. (Library)
